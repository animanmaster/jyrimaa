...
class PieceData:
    ...
    def get_hash(self, radius=None):
        ...
        '00000200010002000100010003012100100000210001010100010000000001000000010200000000000000080000000000000100000000050000040000000000000000010000'
        '''
        if not self.hashed:
            ...
            for r in range(self.MAX_RADIUS):
                ...
                values.append(str(self.boundary_distances.count(r+1)))
                values.append(str(self.trap_distances.count(r+1)))
